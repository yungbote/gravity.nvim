...
M.load = function(opts)
	...
	hi("Include", { fg = colors.include_keyword })
	...
	hi("@keyword.import", { fg = colors.include_keyword })
	hi("@keyword.import.c", { fg = colors.include_keyword })
	hi("@keyword.import.cpp", { fg = colors.include_keyword })
