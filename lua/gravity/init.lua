...
M.load = function(opts)
	...
	hi("Include", { fg = colors.include_keyword, gui = "bold" })
	hi("Define", { link = "PreProc" })
	hi("Macro", { link = "PreProc" })
	hi("PreCondit", { link = "PreProc" })
	hi("cInclude", { link = "Include" })
	hi("cppInclude", { link = "Include" })
	hi("cIncluded", { fg = colors.include_path, gui = "italic" })
	hi("cppIncluded", { fg = colors.include_path, gui = "italic" })
	hi("StorageClass", { link = "Type" })
	hi("Structure", { link = "Type" })
	hi("Typedef", { link = "Type" })
	hi("Tag", { link = "Special" })
	hi("SpecialChar", { link = "Special" })
	hi("SpecialComment", { fg = colors.teal, gui = "italic" })
	...
	hi("@string.escape", { fg = colors.string_pink, gui = "italic" })
	...
	hi("@attribute", { fg = colors.green, gui = "italic" })
	hi("@include", { link = "Include" })
	hi("@preproc", { link = "PreProc" })
	hi("@keyword.import", { fg = colors.include_keyword, gui = "bold" })
	hi("@keyword.import.c", { fg = colors.include_keyword, gui = "bold" })
	hi("@keyword.import.cpp", { fg = colors.include_keyword, gui = "bold" })
	hi("@keyword.directive", { fg = colors.include_keyword, gui = "bold" })
	hi("@keyword.directive.c", { fg = colors.include_keyword, gui = "bold" })
	hi("@keyword.directive.cpp", { fg = colors.include_keyword, gui = "bold" })
	hi("@string.special.path", { fg = colors.include_path, gui = "italic" })
	hi("@string.special.path.c", { fg = colors.include_path, gui = "italic" })
	hi("@string.special.path.cpp", { fg = colors.include_path, gui = "italic" })
