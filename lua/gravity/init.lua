...
M.load = function(opts)
	...
	hi("cIncluded", { fg = colors.include_path })
	hi("cppIncluded", { fg = colors.include_path })
	...
	hi("@keyword.directive", { fg = colors.include_keyword })
	hi("@keyword.directive.c", { fg = colors.include_keyword })
	hi("@keyword.directive.cpp", { fg = colors.include_keyword })
	hi("@string.special.path", { fg = colors.include_path })
	hi("@string.special.path.c", { fg = colors.include_path })
	hi("@string.special.path.cpp", { fg = colors.include_path })
